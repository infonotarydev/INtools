...
public class ObjectsToJson {
    ...
    public static String getOrderedJson(JSONObject json) throws JSONException, UnsupportedEncodingException {
        Map<String, Object> sortedMapFromJson = JsonToObject.getMapFromJsonObject(json);
        return map2json(sortedMapFromJson);
    }
}