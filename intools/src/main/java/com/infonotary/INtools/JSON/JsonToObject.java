...
public class JsonToObject {
     ...
     * the JSON array.
     * @throws org.json.JSONException if an element of jArray cannot be
     ...
     * @throws org.json.JSONException if an element in jArray cannot be
     *                                converted properly.
     */
     ...
     * @throws org.json.JSONException if an element in jObject cannot be
     *                                converted properly.
     */
    ...
    @SuppressWarnings("unchecked")
    public static Map<String, Object> getMapFromJsonObject(JSONObject jObject) throws JSONException {
        ...
        for (String key : keysList) {
            Object obj = convertJsonItem(jObject.get(key));
            if (obj instanceof Integer) {
                int tempInt = (Integer) obj;
                sortedMap.put(key, tempInt);
            } else {
     ...
     * if o is null.
     * @throws org.json.JSONException if o fails to parse.
     */
    public static Object convertJsonItem(Object o) throws JSONException {
        ...
        if (o instanceof String) {
            if (JsonBooleanTools.isJSONValid((String) o)) {
                o = new JSONObject((String) o);
            } else if (JsonBooleanTools.isJSONArrayValid((String) o)) {
        ...
        if (o instanceof JSONObject) {
            try {
                return getMapFromJsonObject((JSONObject) o);
